...
#####
    ...
    def component_test_template(self, testtype, exp_rc = 0):
        ...
        if exp_rc != 0:
            ...
            filter2 = RemoveRegexFromLineFilter(r"FATAL: #(\[[0-9]+:[0-9]+\])* ")
        ...
        self.assertTrue(cmp_result, "Output/Compare file {0} does not match Reference File {1}".format(testfile, reffile))
