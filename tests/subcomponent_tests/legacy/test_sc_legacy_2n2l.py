...
sub0_0.addParam("unnamed_subcomponent", "coreTestElement.SubCompSenderLegacy")
...
sub0_1.addParam("unnamed_subcomponent", "coreTestElement.SubCompSenderLegacy")
...
sub1_0.addParam("unnamed_subcomponent", "coreTestElement.SubCompReceiverLegacy")
...
sub1_1.addParam("unnamed_subcomponent", "coreTestElement.SubCompReceiverLegacy")
