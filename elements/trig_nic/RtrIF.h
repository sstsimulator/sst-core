...
public:
	...
	m_cpuLink->setDefaultTimeBase(registerTimeBase("1ns"));
	// The self link will use ns as a timebase
	m_selfLink->setDefaultTimeBase(registerTimeBase("1ns"));
