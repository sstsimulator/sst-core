...
int main(int argc, char **argv) {
    ...
    if (4 != argc) {
        fprintf(stderr, "Usage: %s x_count y_count z_count\n", basename(argv[0]));
        exit(1);
   }
    ...
    printf("\n");
    printf("<cpu_params>\n");
    printf("    <radix> 4 </radix>\n");
    printf("    <nodes> %d </nodes>\n",size);
    printf("    <msgrate> 5MHz </msgrate>\n",size);
    printf("</cpu_params>\n");
    printf("\n");
    printf("<nic_params1>\n");
    printf("    <clock>500Mhz</clock>\n");
    ...
    printf("    <dummy.latency> 250 </dummy.latency>\n");
    printf("</nic_params2>\n");
    printf("\n");
    printf("<nicLink>\n");
    printf("    <lat>1ps</lat>\n");
	...
	printf("    <component id=\"%d.cpu\" >\n",i);
	printf("        <trig_cpu>\n");
	printf("            <params include1=cpu_params>\n");
	printf("                <id> %d </id>\n",i);
	printf("            </params>\n");
	printf("            <links>\n");
	printf("                <link id=\"%d.cpu2nic\">\n",i);
