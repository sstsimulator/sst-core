...
StatisticOutputCompressedTxt::StatisticOutputCompressedTxt(Params& outputParameters) 
...
bool StatisticOutputCompressedTxt::checkOutputParameters()
{
    bool foundKey;
...
void StatisticOutputCompressedTxt::printUsage()
{
...
void StatisticOutputCompressedTxt::startOfSimulation() 
{
    ...
    if (true == m_outputTopHeader) {
        ...
        gzprintf(m_hFile, "%s; ", m_outputBuffer.c_str());
...
void StatisticOutputCompressedTxt::endOfSimulation() 
{
    // Close the file
    gzclose(m_hFile);
}

void StatisticOutputCompressedTxt::implStartOutputEntries(StatisticBase* statistic) 
{
    char buffer[256];
...
void StatisticOutputCompressedTxt::implStopOutputEntries() 
{
    // Done with Output
    gzprintf(m_hFile, "%s\n", m_outputBuffer.c_str());
}

void StatisticOutputCompressedTxt::implOutputField(fieldHandle_t fieldHandle, int32_t data)
{
    char buffer[256];
...
void StatisticOutputCompressedTxt::implOutputField(fieldHandle_t fieldHandle, uint32_t data)
{
    char buffer[256];
    StatisticFieldInfo* FieldInfo = getRegisteredField(fieldHandle);
...
void StatisticOutputCompressedTxt::implOutputField(fieldHandle_t fieldHandle, int64_t data)
{
    char buffer[256];
    StatisticFieldInfo* FieldInfo = getRegisteredField(fieldHandle);
...
void StatisticOutputCompressedTxt::implOutputField(fieldHandle_t fieldHandle, uint64_t data) 
{
    char buffer[256];
    StatisticFieldInfo* FieldInfo = getRegisteredField(fieldHandle);
...
void StatisticOutputCompressedTxt::implOutputField(fieldHandle_t fieldHandle, float data)
{
    char buffer[256];
    StatisticFieldInfo* FieldInfo = getRegisteredField(fieldHandle);
...
void StatisticOutputCompressedTxt::implOutputField(fieldHandle_t fieldHandle, double data)
{
    char buffer[256];
    StatisticFieldInfo* FieldInfo = getRegisteredField(fieldHandle);
...
BOOST_CLASS_EXPORT_IMPLEMENT(SST::Statistics::StatisticOutputCompressedTxt)
