...
#    fi
    ...
    case $1 in
        ...
        sstmainline_config_gem5_gcc_4.6.4) 
            #-----------------------------------------------------------------
            # sstmainline_config
