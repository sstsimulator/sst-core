...
getconfig() {
    ...
    case $1 in
        sst3.0_config)
            ...
            depsStr="-k none -d 2.2.2 -p none -z none -b 1.50 -g stabledevel -m none -i none -o none -h none -s 2.4.0 -q stabledevel -M 1.2_pre"
...
"
        ...
        portals4_test|M5_test)
            ...
            ;;
        zesto_test)
            depsStr="-k none -d none -p none -z none -g stabledevel -m none -i none -o none -h none -s none -4 stabledevel -q stabledevel -M 1.2_pre"
            setConvenienceVars "$depsStr"
