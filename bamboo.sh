...
#    fi
    ...
    case $1 in
        sstmainline_config) 
            ...
            depsStr="-k none -d 2.2.2 -p none -z none -b 1.50 -g stabledevel -m none -i none -o none -h none -s none -q 0.2.1 -M 2.0.3 -N default -z 3.8 -c default"
        ...
        sstmainline_config_static) 
            ...
            export | egrep SST_DEPS_
            miscEnv="${mpi_environment}"
            depsStr="-k none -d 2.2.2 -p none -z none -b 1.50 -g stabledevel -m none -i none -o none -h none -s none -q 0.2.1 -M 2.0.3 -N default -z 3.8"
            setConvenienceVars "$depsStr"
        ...
        sstmainline_config_macosx) 
            ...
            export | egrep SST_DEPS_
            miscEnv="${mpi_environment}"
            depsStr="-k none -d 2.2.2 -p none -z none -b 1.50 -g stabledevel -m none -i none -o none -h none -s none -q none -z 3.8 -N default -M 2.0.3"
            setConvenienceVars "$depsStr"
