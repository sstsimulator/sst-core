...
#    fi
    ...
    case $1 in
        ...
        sstmainline_config_all) 
            ...
            ;;
        sstmainline_config_stream|sstmainline_config_openmp|sstmainline_config_diropenmp|sstmainline_config_diropenmpB) 
            #-----------------------------------------------------------------
