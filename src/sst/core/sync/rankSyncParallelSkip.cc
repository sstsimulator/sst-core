...
#define SST_EVENT_PROFILE_START auto start = std::chrono::high_resolution_clock::now();
...
ActivityQueue*
RankSyncParallelSkip::registerLink(const RankInfo& to_rank, const RankInfo& from_rank, LinkId_t link_id, Link* link)
{
