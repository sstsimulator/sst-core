...
###
    ...
    def compare_sorted(self, outfile, reffile):
       sorted_outfile = "{0}/coreTestComponent_sorted_outfile".format(get_test_output_tmp_dir())
       sorted_reffile = "{0}/coreTestComponent_sorted_reffile".format(get_test_output_tmp_dir())
