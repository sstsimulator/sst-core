    ...
    late_initialize(false)
{
    ...
    registerClock("1GHz", new Clock::Handler<coreTestSharedObjectsComponent>(this, &coreTestSharedObjectsComponent::tick));
}


void coreTestSharedObjectsComponent::init(unsigned int UNUSED(phase))
{
...
void coreTestSharedObjectsComponent::setup()
{
    if ( late_initialize ) {
...
void coreTestSharedObjectsComponent::complete(unsigned int UNUSED(phase))
{
}

void coreTestSharedObjectsComponent::finish()
{
}
