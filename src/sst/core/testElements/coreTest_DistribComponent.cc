...
void coreTestDistribComponent::finish()
{
    if (bin_results) {
    ...
    Component(id)
{
    ...
    //set our clock
    registerClock("1GHz", new Clock::Handler<coreTestDistribComponent>(this,
                  &coreTestDistribComponent::tick));
}
...
bool coreTestDistribComponent::tick(Cycle_t UNUSED(cyc))
{
