...
#include "sst/core/testElements/coreTest_SubComponentLegacy.h"
#include "sst/core/testElements/coreTest_Message.h"

#include <sst/core/timeConverter.h>

using namespace SST;
using namespace SST::CoreTestSubComponentLegacy;
...
void SubCompReceiver::clock(Cycle_t UNUSED(cyc))
{
    /* Do nothing */
}
