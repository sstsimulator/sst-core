...
class serialize_impl<std::variant<Types...>>
{
    ...
    //
    // This defines a partial specialization of the serialize_impl<std::variant<Types...>>::set_index static member
    // variable template, which takes a single "type" template argument. This specialization matches
    // std::index_sequence<INDEX...> representing a sequence of subscripts 0, 1, 2, ..., sizeof...(Types)-1 generated by
    ...
    // swap of the std::variant object or a call to the emplace() method.
    //
    ...
    //
    // array = { obj.emplace<0>(), obj.emplace<1>(), obj.emplace<2>(), ..., obj.emplace<sizeof...(Types)-1>() }
