    ...
    InteractiveConsole()
{
    ...
    cmdRegistry = {
       ...
       { "examine", "e", "<obj> prints object in the current scope. See SimpleDebugger::cmd_examine", ConsoleCommandGroup::STATE,
            [this](std::vector<std::string>& tokens) { cmd_examine(tokens); } },      
