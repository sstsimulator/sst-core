...
// SST and ZOLTANs configurations are conflicting on the SST_CONFIG_HAVE_MPI definition.
// So temporarily shut down SSTs SST_CONFIG_HAVE_MPI, then allow ZOLTANs SST_CONFIG_HAVE_MPI to
//be defined, then reset SSTs SST_CONFIG_HAVE_MPI.
