...
public:
    ...
    */
     ...
     */
    const_iterator begin() const { return data->array.cbegin(); }

    /**
       Get const_iterator to end of underlying map
     */
    const_iterator end() const { return data->array.cend(); }

    /**
       Get const_reverse_iterator to beginning of underlying map
     */
    const_reverse_iterator rbegin() const { return data->array.crbegin(); }

    /**
       Get const_reverse_iterator to end of underlying map
     */
    const_reverse_iterator rend() const { return data->array.crend(); }
     ...
     */
    inline const T& operator[](int index) const { return data->read(index); }
    ...
    void serialize_order(serializer& ser) override
    {
        ...
        if ( mode == serializer::MAP )
            ser.mapper().map_hierarchy_start(ser.getMapName(), new ObjectMapContainer<SharedArray>(this));
        ...
        case serializer::MAP:
            if ( initialized ) SST_SER_NAME(data->array, "data");
            ser.mapper().map_hierarchy_end();
            break;
        }
    }

    ImplementSerializable(SharedArray<T>)
...
private:
    ...
    public:
        ...
        */
        ...
        inline const T& read(int index) const { return array[index]; }
        ...
        ImplementSerializable(SharedArray<T>::Data);
    ...
    private:
        class ChangeSet : public SharedObjectChangeSet
        {
            ...
            ImplementSerializable(SharedArray<T>::Data::ChangeSet);
...
public:
    ...
    */
        ...
        const std::string& obj_name, size_t length = 0, bool init_value = false, verify_type v_type = INIT_VERIFY)
    {
        ...
        int ret = incShareCount(data);
        if ( length != 0 ) {
            data->setSize(length, init_value, v_type);
        }
    ...
    /**
       ...
       @return const reference to data at index
     */
    inline bool operator[](int index) const { return data->read(index); }
    ...
    ImplementSerializable(SharedArray<bool>)
...
private:
    ...
    public:
        ...
        */
        ...
        // danger of the array being resized during init, use the
        // mutex_read function until after the init phase.
        inline bool read(int index) const { return array[index]; }
        ...
        ImplementSerializable(SharedArray<bool>::Data);
    ...
    private:
        class ChangeSet : public SharedObjectChangeSet
        {
            ...
            ImplementSerializable(SharedArray<bool>::Data::ChangeSet);
